...
class _NewPostPageState extends State<NewPostPage> {
  ...
  final TextEditingController _imageUrlController = TextEditingController(
    text:
        "https://ugc.futurelearn.com/uploads/images/7a/1a/large_hero_7a1aec47-8310-4f1a-887c-3afa46c72495.jpg",
  );
  ...
  Future<void> _submitArticle() async {
    ...
    if (selectedCategory == null) {
      // Menampilkan validasi kategori tanpa snackbar
      setState(() {
        // Trigger rebuild untuk menampilkan error validator
      });
      return;
    }
    ...
    try {
      // Pastikan format data sesuai dengan API
      final articleData = {
        ...
        "tags":
            _hashtagsController.text.isEmpty
                ...
                : _hashtagsController.text
                    .split(',')
                    .map((e) => e.trim())
                    .where((e) => e.isNotEmpty) // Filter string kosong
                    .toList(),
        "content": _contentController.text,
      };

      // Log data sebelum mengirim
      print('Data artikel yang akan dikirim: $articleData');

      // Gunakan controller untuk membuat artikel
